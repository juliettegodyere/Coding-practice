/**
 * 1. Like the naive algorithm, we slide the text one by one.
 * 2. Compare hash values of pattern and the current text window.
 * If hash values match, then only compare individual character.
 */
